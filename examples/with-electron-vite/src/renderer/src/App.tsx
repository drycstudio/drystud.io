    ...
    submenu: [
      ...
      { label: 'Open Folder...', shortcut: 'Ctrl+Shift+O', action: () => console.log('Open Folder') },
      {
        ...
        submenu: [
          ...
          { label: '~/projects/electron-titlebar', action: () => console.log('Open electron-titlebar') },
          { type: 'separator', label: '' },
      ...
      { type: 'separator', label: '' },
      {
        ...
        submenu: [
          ...
          { type: 'separator', label: '' },
          {
            label: 'Color Theme',
            submenu: [
              { label: 'Dark+ (default)', action: () => console.log('Dark+') },
              { label: 'Light+', action: () => console.log('Light+') },
              { label: 'Monokai', action: () => console.log('Monokai') },
              { label: 'Solarized Dark', action: () => console.log('Solarized Dark') },
            ],
          },
        ],
      },
